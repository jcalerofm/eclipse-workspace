...
public class AlumnoController {
  ...
  public void miBinder(WebDataBinder binder) {
    StringTrimmerEditor espaciosBlancos = new StringTrimmerEditor(true);
    binder.registerCustomEditor(String.class, espaciosBlancos);
  }
